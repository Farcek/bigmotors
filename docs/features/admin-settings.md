...
| Constant | Key | UI |
| --- | --- | --- |
| SETTINGS_KEY_HOMEPAGE | homepage | Нийтэлсэн Page-уудаас хайж сонгох, цэвэрлэх боломжтой select |
...
- Нэг save хүсэлт зөвхөн эдгээр гурван key-г явуулна. Дурын key нэмэх/устгах ерөнхий editor UI байхгүй.
- UI имэйлийн хэлбэр, 255 тэмдэгтийн хязгаар, шинээр сонгосон page published эсэхийг шалгана. API нь эдгээр key-д тусгай утгын validation хийхгүй.
- Нийтэлсэн Page-ийн бүх хуудсыг pagination-аар ачаална; эхний 100-аар хязгаарлахгүй.
- Өмнө тохируулсан homepage устсан/нийтлэгдээгүй/буруу утгатай бол warning харуулж, шинэ сонголтод санал болгохгүй. Өөр талбар засахад хуучин утгыг чимээгүй арилгахгүй; хэрэглэгч солих эсвэл цэвэрлэх боломжтой.
