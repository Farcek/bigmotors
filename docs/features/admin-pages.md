...
- Website зөвхөн `/:slug` дээр published Page-ийн content-ийг JSON string болгон харуулна. `/` нь Page module-оос тусдаа өөрийн нүүр хуудас. [Website routing](website-routing.md). Navigation/menu, preview болон Puck холбоогүй.
