...
DB, DTI, API, admin болон public нүүрний бүлгийн grid холбогдсон. Public ажиллагааг [website routing](website-routing.md#нүүрний-бүтээгдэхүүний-бүлэг)-д тайлбарласан. Сэлбэг/дугуйн бүлэг, динамик SQL engine, олон утгатай OR нөхцөл ороогүй.
