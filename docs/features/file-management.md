...
- Request-ийн originalName нь header болон disk path-д нөлөөлөхгүй. Эх файл `Cache-Control: no-store`, resize хувилбар `public, max-age=3600`; `X-Content-Type-Options: nosniff`, `Content-Security-Policy: sandbox; default-src 'none'` хэрэглэнэ. Одоогоор Range болон Last-Modified/conditional cache идэвхжүүлэхгүй.
- `?w=240|480|800|1280|1920` хүсэлтээр эх зургийг хадгалсан хэвээр WebP хувилбар үүсгэж, тохируулдаг `FILES_CACHE` хавтсанд дахин ашиглана. Харьцааг хадгална, crop/upscale хийхгүй. `w`-гүй read эх byte буцаах дүрэм хэвээр. GET/HEAD, хязгаар болон алдааны дэлгэрэнгүй нь [resize/cache](../operations/file-storage.md#зургийн-resize-ба-cache)-д байна.
