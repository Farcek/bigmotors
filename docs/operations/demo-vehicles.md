...
- Огноо: 2026-09-12
- Зориулалт: хэрэглэгчийн сонгосон API-д зурагтай 20 машин болон нүүр хуудасны 10 бүтээгдэхүүний бүлгээр form, жагсаалт, хайлт, шүүлтийг турших. Орчноос хамаарсан хориггүй; зөвхөн гараар ажиллуулна.
...
20 машины алхмын дараа `/api/home-product-groups` CRUD-аар 10 бүлэг нэмнэ.
Өгөгдөл: [product-group-data.ts](../../sysop/server/src/dev/product-group-data.ts).
Команд болон Railway job-ийн env өөрчлөгдөхгүй. Өмнөх 20 машин зурагтай бол тэдгээрийг
алгасаад дутуу бүлгүүдийг нэмнэ; зураг дахин татах/upload хийхгүй.

| Бүлэг | Шүүлтүүр | Анхны төлөв |
| --- | --- | --- |
| Toyota | brand | active |
| Lexus | brand | active |
| Toyota Prius | brand + model | active |
| Жийп / SUV | category | active |
| Седан | category | active |
| Хайбрид | fuel=hybrid | active |
| Дизель | fuel=diesel | active |
| 2,000 cc хүртэл | engine_max=2000 | active |
| Бүх дугуйн хөтлөгч | drivetrain=awd | inactive |
| Шинэ автомашин | condition=new | inactive |

Filter нь shared `VehicleSearchParams` contract, бүх утга string. UUID-ууд target API-ийн
лавлахаас resolve хийгдэнэ. Зураг нь тухайн demo машины `mainImageId`; шинэ file үүсгэхгүй,
usage холбоосыг existing group CRUD transaction/trigger удирдана.

Бүлгийн `description`-ийн эхний мөр `bigmotors-demo-home-groups-v1:NN` marker байна.
Гарчгийг өөрчилсөн ч marker хэвээр бол давтан үүсгэхгүй. Байгаа бүлгийн title, filters,
зураг, эрэмбэ, active төлөвийг өөрчлөхгүй; анхны 8/2 төлөвийг дахин хүчээр оноохгүй.
Ижил нэртэй боловч marker-гүй бусад бүлгийг demo гэж үзэхгүй. Marker устгавал давхар
үүсэх боломжтой; ижил marker давхардсан бол бичихээс өмнө алдаа өгнө. Import-ийг зэрэг ажиллуулахгүй.

Бүх missing бүлгийн image ID-г бүлэг бичихээс өмнө шалгана. Хэсэгчлэн амжилттай болсон
үед өмнөх бүлгүүд үлдэнэ; дараагийн run зөвхөн дутууг нөхнө. `Product groups` логт created/skipped тоо гарна.
Шинэ active бүлэг нүүр хуудсанд шууд харагдаж болно. Машинуудыг автоматаар нийтлэхгүй учир
ноорог машинтай үед public count 0 байж болно. Энэ import `home` gallery үүсгэхгүй.

Бүлгийн нэмэлтийг server-ийн 108 тест, typecheck болон compiled CLI build-ээр шалгасан.
Тусгаарласан HTTP/DB тест нь 10 бүлэг, 8/2 төлөв, shared file usage, давтан run-ийг;
unit тестүүд нь marker давхардал, хэрэглэгчийн өөрчлөлт хадгалах, зураг дутуу preflight
болон тасарсан/response алдагдсан import-ийг үргэлжлүүлэхийг шалгана. Энэ өөрчлөлтөөр
бодит local/Railway DB-д бүлэг нэмээгүй.
