...
CREATE TABLE "colors" (
	...
	CONSTRAINT "colors_hex_code_format" CHECK ("colors"."hex_code" is null or "colors"."hex_code" ~ '^#[0-9A-Fa-f]{6}$')
);
--> statement-breakpoint
...
CREATE TABLE "product_images" (
	...
	"sort_order" integer DEFAULT 0 NOT NULL,
	CONSTRAINT "product_images_product_file_unique" UNIQUE("product_id","file_id"),
...
CREATE INDEX "tires_branch_idx" ON "tires" USING btree ("branch_id");--> statement-breakpoint
