...
export namespace VehicleModels {
  ...
  export const list = createAction("vehicleModelList", { query: listQuery, result: listResult }, { path: "/vehicle-models", method: "GET" });
  export const create = createAction("vehicleModelCreate", { body: createBody, result: entity }, { path: "/vehicle-models", method: "POST" });
  export const update = createAction("vehicleModelUpdate", { params, body: updateBody, result: entity }, { path: "/vehicle-models/:id", method: "PATCH" });
  export const remove = createAction("vehicleModelDelete", { params, result: entity }, { path: "/vehicle-models/:id", method: "DELETE" });
}
