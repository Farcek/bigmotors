...
export namespace TireBrands {
  ...
  export const list = createAction("tireBrandList", { query: listQuery, result: listResult }, { path: "/tire-brands", method: "GET" });
  export const create = createAction("tireBrandCreate", { body: createBody, result: entity }, { path: "/tire-brands", method: "POST" });
  export const update = createAction("tireBrandUpdate", { params, body: updateBody, result: entity }, { path: "/tire-brands/:id", method: "PATCH" });
  export const remove = createAction("tireBrandDelete", { params, result: entity }, { path: "/tire-brands/:id", method: "DELETE" });
}
